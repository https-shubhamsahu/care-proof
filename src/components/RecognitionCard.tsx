    ...
    >
      ...
      <div className="relative z-10">
        ...
        <p className="text-lg leading-relaxed text-foreground mb-2 font-heading">
          You managed <span className="text-primary font-semibold">14 caregiving responsibilities</span> today.
        </p>
        <p className="text-muted-foreground leading-relaxed mb-6">
          That level of coordination matches professional care managers. Your ability to navigate complex, overlapping demands demonstrates leadership that most systems fail to measure — but we see it.
        </p>
