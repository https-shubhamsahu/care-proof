  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-hero overflow-hidden pt-16">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 w-96 h-96 rounded-full bg-verified/3 blur-3xl animate-pulse-glow" style={{ animationDelay: "2s" }} />
      </div>
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        >
          <motion.img
            src={logo}
            alt="CareProof logo"
            className="w-24 h-24 rounded-full glow-primary"
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <span className="text-gradient-primary inline-flex items-center gap-2">
                matters.
                <HeartHandshake className="w-8 h-8 md:w-10 md:h-10 text-primary inline" />
              </span>
              <br />
              Let's turn it into{" "}
          ...
          >
            <Button asChild size="lg" className="bg-primary text-primary-foreground hover:bg-primary/90 glow-primary px-8 text-base rounded-2xl">
              <Link to="/upload">
                Start Documenting Your Care
                <ArrowRight className="ml-2 h-4 w-4" />
              </Link>
            </Button>
            <Button asChild variant="outline" size="lg" className="border-border/50 text-muted-foreground hover:text-foreground hover:bg-muted/30 px-8 text-base rounded-2xl">
              <a href="#how-it-works">
