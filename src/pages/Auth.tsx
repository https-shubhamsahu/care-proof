  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="flex items-center justify-center min-h-screen pt-16 px-6">
        ...
        >
          <img src={logo} alt="CareProof" className="w-16 h-16 rounded-full mx-auto mb-6" />
          <h1 className="text-2xl font-semibold mb-2 font-heading">Welcome to CareProof</h1>
          <p className="text-sm text-muted-foreground mb-8">
            Sign in to build your verified caregiving portfolio.
          </p>
